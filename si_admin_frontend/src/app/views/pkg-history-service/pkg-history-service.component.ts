...
export class PkgHistoryServiceComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.manageUsers.getServiceStatus(this.pk_id,this.mobile).subscribe(
      (data:any[])=>{
       this.details=data;
    ...
    this.manageUsers.getServiceNotInOrderMaintaintbl(this.pk_id,this.mobile,this.pk_id).subscribe(
      (data:any[])=>{
