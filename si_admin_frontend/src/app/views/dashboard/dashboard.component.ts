...
export class DashboardComponent implements OnInit {
  ...
  failService(id:number,mobile:number,s_name:string,e_name:string,p_name:string)
  {
  ...
  completeService(id:number,mobile:number,s_name:string,e_name:string,p_name:string)
  {
