          ...
          for(this.i=0;this.i<this.arr.length;this.i++)
          {
            ...
            this.date2= new Date(this.arr[this.i].pp_endDate);
             if(currDate>=this.date1 && currDate<=this.date2)
             {
              ...
              const data1={pk_id:this.arr[this.i].pk_id,pk_name:this.arr[this.i].pk_name,pp_date:d,pp_endDate:d1,status:"Ongoing"};
             ...
             else
             {
              ...
              const data1={pk_id:this.arr[this.i].pk_id,pk_name:this.arr[this.i].pk_name,pp_date:d,pp_endDate:d1,status:"Expired"};
              this.details.push(data1);
              this.dataSource.data = this.details;
            }
          }
