...
export class ManageUsersService {
  ...
  getServiceStatus(pk_id: number, p_mobile: number) {
    return this.http.get(
      this.baseURL + "servicestatus/" + pk_id + "/" + p_mobile
    );
  }
  getServiceNotInOrderMaintaintbl(pk_id, p_mobile, pk_id1) {
    return this.http.get(
      this.baseURL + "servicenotorder/" + pk_id + "/" + p_mobile + "/" + pk_id1
    );
  }
